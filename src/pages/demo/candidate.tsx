...
export default function DemoCandidatePage({ roles }: Props) {
  ...
  return (
    <>
      <Head>
        <title>Candidate demo · PurpleHire</title>
        <meta
          name="description"
          content="Take a sample PurpleHire interview as a candidate, no sign-in."
        />
      </Head>
        ...
        <section className="mx-auto grid min-h-[calc(100vh-80px)] max-w-3xl place-items-center px-4 py-10 sm:px-8 sm:py-16">
          <div className="w-full">
            <div className="mb-6 flex justify-center">
              <PHEyebrow live>Try it as a candidate</PHEyebrow>
            </div>
